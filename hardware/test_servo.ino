/*
 * TEST SIMPLE - Servo Motor con Arduino Mega 2560
 * 
 * Propósito: Probar que el servo funciona antes de integrar todo el sistema
 * 
 * Conexiones:
...
void setup() {
  Serial.begin(115200);
  Serial.println("Test de Servo - ATmega2560");
